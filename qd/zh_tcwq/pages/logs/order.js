    ...
    refresh: function(t) {
        ...
        app.util.request({
            ...
            success: function(t) {
                console.log(t);
                var e = [], a = [], r = [], o = [], n = [];
                for (var s in t.data) t.data[s].time = app.ormatDate(t.data[s].time), 1 == t.data[s].state ? e.push(t.data[s]) : 2 == t.data[s].state ? a.push(t.data[s]) : 3 == t.data[s].state ? (t.data[s].time = d(t.data[s].time, 7), 
                console.log(i), t.data[s].time >= i ? console.log(t.data[s]) : app.util.request({
